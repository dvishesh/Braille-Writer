 ...
 // REGISTER READ/WRITE FUNCTIONS
     ...
     */
     ...
     static void setControlReg1(uint8_t registervalue)
     {
         ...
         buf[0] = CTRL_REG1 ;
         buf[1] = registervalue;
         Chip_I2C_MasterSend(I2C1, ACC_I2C_ADDRESS, buf, 2);
     }
      ...
      static uint8_t getModeControlReg1(void)
          	 {
          	     ...
          	     Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, CTRL_REG1, buf, 1);
          	     registervalue = buf[0];
...
*****************************************************************************/
     ...
     void ReadPulseSource1(void)
     {
    	 ...
    	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, PULSE_SRC, buf, 1);
     }
     ...
     uint8_t GetINT_SRC_Status1(void)
     {
    	 ...
    	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, INT_SOURCE, buf, 1);
    	 return buf[0];
     ...
     uint8_t Get_STATUS1(void)
     {
    	 ...
    	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, STATUS, buf, 1);
         return buf[0];
     }
     ...
     uint8_t Get_WHOAMI1(void)
        {
       	...
       	buf[0] = 0;
       	 ...
       	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, WHO_AM_I, buf, 1);
            return buf[0];
        }
     ...
     uint8_t Get_ZPULSETHRESHOLD1(void)
             {
            	...
            	buf[0] = 0;
            	 ...
            	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, PULSE_THSZ , buf, 1);
                 return buf[0];
             }
     ...
     uint8_t Get_ZPULSE_TMLIMIT1(void)
             {
            	...
            	buf[0] = 0;
            	 ...
            	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, PULSE_TMLT , buf, 1);
                 return buf[0];
             }
     ...
     uint8_t Get_ZPULSE_TMLATENCY1(void)
             {
            	...
            	buf[0] = 0;
            	 ...
            	 Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, PULSE_LTCY , buf, 1);
                 return buf[0];
             }
     ...
     void acc1_read (int16_t *z)
     {
        ...
        Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, OUT_Z_MSB , zvalue_hi, 1);
        Chip_I2C_MasterCmdRead(I2C1, ACC_I2C_ADDRESS, OUT_Z_LSB , zvalue_low, 1);
